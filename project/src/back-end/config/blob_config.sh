...
# Download image
curl -X GET https://res.cloudinary.com/sivadass/image/upload/v1493620045/dummy-products/mango.jpg /
            --output ${IMAGE}
...
# Upload
curl -X PUT -T ${IMAGE} -H "x-ms-date: $(date -u)" -H "x-ms-blob-type: BlockBlob" "https://myblob9.blob.core.windows.net/images/${IMAGE}"
